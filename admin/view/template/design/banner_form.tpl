          ...
          <tbody id="image-row<?php echo $image_row; ?>">
            <tr>
              <td class="left"><?php foreach ($languages as $language) { ?>
                ...
                <td>
                  <textarea style="width:300px; height:150px;" name="banner_image[<?php echo $image_row; ?>][description]"  value="<?php echo $banner_image['description']; ?>" id="description">
                  <?php echo isset($banner_image['description']) ? $banner_image['description'] : ''; ?></textarea>    
                </td>
