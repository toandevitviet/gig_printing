          ...
          <thead>
            <tr>
              ...
              <td class="left"><?php if ($sort == 'status') { ?>
                ...
                <?php } ?></td>
				<td class="left"><?php echo $column_caption; ?></td>
          ...
          <tbody>
            ...
            <tr>
              <td style="text-align: center;"><?php if ($slider['selected']) { ?>
                ...
                <?php } ?></td>
              <td class="left"><?php echo $slider['name']; ?></td>
              <td class="left"><?php echo $slider['status']; ?></td>
			  <td class="left"><?php echo $slider['caption']; ?></td>
              <td class="right"><?php foreach ($slider['action'] as $action) { ?>
