          ...
          <table class="form">
            ...
            <tr>
              ...
              <td>
                ...
                <?php $ct = $category_type;?>
                <option value="top" <?php if($ct == 'top') print('selected="selected"'); ?> >Top category</option>
                <option value="card" <?php if($ct == 'card') print('selected="selected"'); ?> >Category group</option>
                <option value="advs" <?php if($ct == 'advs') print('selected="selected"'); ?> >Advertising</option>
                </select>
              </td>
            </tr>
