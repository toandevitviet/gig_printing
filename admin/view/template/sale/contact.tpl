...
//initialization text
CKEDITOR.instances.message.setData( '<p><img alt="GIG Printing" src="http://gigprinting.sssmine.org/image/data/logo.png" title="GIG Printing" /></p><p>Change content here</p><p>Regards, GIG</p><p>This email was intended for Add Sales@gig.sg into your address book to ensure that our emails do not end up as spams.Click here to view our Privacy Policy.</p>', function()
    {
