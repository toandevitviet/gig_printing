				...
				<table class="form">
					<tr>
						<tr>
							...
							<td>
								<input type="text" name="watermark_name" value="Sample Watermark"/>
							</td>
						</tr>
						<td>
							Watermark Type
					...
					<tr class="new_watermark_image" style="display:none;">
						...
						<td>
							<div class="image">
								<img src="<?php echo $no_image; ?>" alt="" id="watermark-image" />
								<input type="hidden" name="watermark_image" value="data/watermark.png" id="watermark_image_value" />
								<br />
					...
					<tr class="new_watermark_text">
						...
						<td><input type="text" name="watermark_text[text]" value="Sample" /></td>
					</tr>
					<tr class="new_watermark_text">
						<td>
					...
					<tr class="new_watermark_text">
						...
						<td>
							<div id="watermark_text_color_widget">
								<div id="watermark_text_colorSelector"><div style="background-color: #00ff00"></div></div>
								<div id="watermark_text_colorpickerHolder">
								</div>
							</div>
							<input type="hidden" name="watermark_text[color]" value="00ff00" id="watermark_color_picker_value"/>
					...
					<tr class="new_watermark_text">
						...
						<td>
							...
							<input type="hidden" name="watermark_text[font_size]" value="10" id="watermark_text_font_size"/>							
						</td>
					</tr>				
					<tr class="new_watermark_text">
						<td>
						...
						<td>
							...
							<input type="hidden" name="watermark_text[opacity]" value="100" />
						</td>
					</tr>
